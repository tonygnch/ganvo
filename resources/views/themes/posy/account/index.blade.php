...
@section('content')
    <style>
        ...
        .acct-main h2 { font-family: var(--display); font-size: clamp(28px, 3.4vw, 42px); margin-bottom: 22px; font-weight: 400; }
        .acct-main h2 em { font-family: var(--serif); font-style: italic; color: var(--accent); }

        .order { background: var(--card); border-radius: 12px; margin-bottom: 18px; overflow: hidden; box-shadow: 0 12px 30px -24px rgba(40, 50, 31, .4); }
        ...
        .order .act a:hover { background: var(--accent); border-color: var(--accent); color: #fbfcf5; }

        .acct-empty { background: var(--card); border: 1px solid var(--line); border-radius: 14px; text-align: center; padding: 56px 24px; box-shadow: 0 16px 38px -26px rgba(40, 50, 31, .4); }
