...
@section('content')
    <style>
        /* ===== Category — sage filter rail + polaroid grid ===== */
        ...
        .pills span.on { color: #fbfcf5; background: var(--accent); border-color: var(--accent); }

        /* filter rail */
        .filters {
            background: var(--card); border: 1px solid var(--line); border-radius: 14px;
            box-shadow: 0 16px 38px -22px rgba(40, 50, 31, .4); overflow: hidden; position: relative;
        }
        ...
        /* result count line — serif italic, florist motif bullet */
        .toolbar {
