...
@section('content')
    ...
    <style>
        ...
        .cart-empty { background: var(--card); border-radius: 14px; box-shadow: 0 16px 38px -22px rgba(40, 50, 31, .4); text-align: center; padding: 70px 28px; margin-top: 26px; position: relative; }
        .cart-empty h2 { font-family: var(--display); font-size: 30px; font-weight: 400; margin-bottom: 10px; }
        ...
        .line { display: grid; grid-template-columns: 100px 1fr auto; gap: 20px; background: var(--card); border-radius: 10px; padding: 18px; margin-bottom: 16px; align-items: center; box-shadow: 0 12px 30px -22px rgba(40, 50, 31, .4); }
        ...
        .summary { background: var(--card); border-radius: 14px; padding: 30px; position: sticky; top: 100px; box-shadow: 0 16px 38px -24px rgba(40, 50, 31, .4); }
        .summary h3 { font-family: var(--display); font-size: 22px; font-weight: 400; margin-bottom: 20px; }
