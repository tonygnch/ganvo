...
@section('content')
    <style>
        ...
        .acct-side a, .acct-side button.link { display: block; width: 100%; text-align: left; padding: 12px 12px; border: none; background: none; border-radius: 9px; font-size: 14px; font-family: inherit; cursor: pointer; color: var(--muted); transition: .18s; }
        .acct-side a:hover, .acct-side button.link:hover { background: var(--soft); color: var(--ink); }
        ...
        .flash { background: color-mix(in srgb, var(--accent) 10%, var(--card)); border: 1px solid var(--accent); color: var(--ink); border-radius: 10px; padding: 13px 16px; margin-bottom: 20px; font-size: 13px; }
        .flash::before { content: "◆ "; color: var(--accent); font-size: 10px; }

        .panel { background: var(--card); border: 1px solid var(--line); border-radius: 14px; padding: 24px; margin-bottom: 18px; }
        .panel h4 { font-family: var(--mono); font-size: 12px; text-transform: uppercase; color: var(--muted); margin-bottom: 18px; }

        .errors { border: 1px solid #c0654a; background: color-mix(in srgb, #c0654a 7%, var(--card)); color: var(--ink); border-radius: 10px; padding: 12px 16px; margin-bottom: 18px; font-size: 13px; }
        ...
        .field input, .field select { border: 1px solid var(--line2); border-radius: 10px; background: var(--bg); padding: 13px 15px; font-family: inherit; font-size: 14px; color: var(--ink); width: 100%; }
