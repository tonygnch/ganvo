...
@section('content')
    <style>
        ...
        .ord-hero .mark {
            ...
            font-size: 32px; line-height: 1; box-shadow: 0 20px 40px -22px color-mix(in srgb, var(--accent) 60%, transparent);
        }
        .ord-hero .mark.danger { background: #c0654a; box-shadow: none; }
        .ord-hero h1 { font-family: var(--display); font-weight: 800; font-size: clamp(34px, 5vw, 56px); line-height: 1.02; letter-spacing: -.02em; margin-bottom: 14px; }
        .ord-hero h1 em { font-style: normal; color: var(--accent); }
        ...
        .ord-ship .ic { width: 48px; height: 48px; border-radius: 12px; background: var(--accent); color: #fff; display: grid; place-items: center; font-size: 22px; flex-shrink: 0; }
        .ord-ship .tx { flex: 1; min-width: 200px; }
        .ord-ship h3 { font-family: var(--display); font-weight: 700; font-size: 17px; margin-bottom: 4px; color: var(--ink); }
        .ord-ship .meta { font-size: 14px; color: var(--muted); }
        .ord-ship .meta code { background: var(--soft); border-radius: 6px; padding: 1px 7px; font-family: var(--mono); font-size: 13px; color: var(--ink); }

        /* ===== detail cards ===== */
        .ord-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 22px; margin-bottom: 22px; }
        .ord-card { background: var(--card); border: 1px solid var(--line); border-radius: 16px; padding: 24px 26px; }
        .ord-card > h3 {
        ...
        .ord-card .row .k { color: var(--muted); font-family: var(--mono); font-size: 11px; }
        ...
        .ord-badge { display: inline-flex; font-family: var(--mono); font-size: 11px; padding: 4px 11px; border-radius: 7px; background: var(--soft); color: var(--ink); }
        .ord-badge.paid { background: color-mix(in srgb, var(--accent) 16%, var(--card)); color: var(--accent); }
        .ord-badge.shipped { background: color-mix(in srgb, var(--accent) 16%, var(--card)); color: var(--accent); }
        ...
        /* ===== items + totals ===== */
        .ord-items { background: var(--card); border: 1px solid var(--line); border-radius: 16px; overflow: hidden; }
        .ord-items > h3 { font-family: var(--mono); font-size: 12px; text-transform: uppercase; color: var(--muted); padding: 20px 26px; border-bottom: 1px solid var(--line); }
        ...
        .ord-item .name { font-family: var(--display); font-weight: 600; font-size: 16px; line-height: 1.2; color: var(--ink); }
        .ord-item .meta { color: var(--muted); font-family: var(--mono); font-size: 12px; margin-top: 3px; }
        .ord-item .pr { font-family: var(--display); font-weight: 600; font-size: 17px; font-variant-numeric: tabular-nums; white-space: nowrap; }

        .ord-tot { padding: 20px 26px 24px; background: var(--bg); }
        ...
        .ord-tot .row code { background: var(--card); border: 1px solid var(--line); border-radius: 5px; padding: 0 6px; font-family: var(--mono); font-size: 12px; color: var(--ink); }
        ...
        .ord-tot .grand .num { font-family: var(--display); font-weight: 800; font-size: 27px; font-variant-numeric: tabular-nums; }
