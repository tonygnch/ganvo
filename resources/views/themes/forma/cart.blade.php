...
@section('content')
    ...
    <style>
        ...
        .cart-empty { background: var(--card); border: 1px solid var(--line); border-radius: 16px; box-shadow: 0 16px 38px -28px rgba(20, 22, 28, .25); text-align: center; padding: 70px 28px; margin-top: 26px; position: relative; }
        .cart-empty h2 { font-family: var(--display); font-size: 30px; font-weight: 800; letter-spacing: -.02em; margin-bottom: 10px; }
        .cart-empty h2 em { font-style: normal; color: var(--accent); }
        .cart-empty p { color: var(--muted); margin-bottom: 26px; }

        .cart { display: grid; grid-template-columns: 1fr 380px; gap: 48px; padding: 20px 0 0; align-items: start; }

        .line { display: grid; grid-template-columns: 90px 1fr auto; gap: 18px; background: var(--card); border: 1px solid var(--line); border-radius: 14px; padding: 16px; margin-bottom: 14px; align-items: center; transition: border-color .13s ease, box-shadow .13s ease; }
        .line:hover { border-color: var(--line2); box-shadow: 0 12px 26px -22px rgba(20, 22, 28, .4); }
        .line .img { height: 90px; width: 90px; border-radius: 10px; overflow: hidden; flex-shrink: 0; }
        .line .img img { width: 100%; height: 100%; object-fit: cover; }
        .line .img .ph, .line .img .bloomph { display: grid; place-items: center; }
        .line .t { font-family: var(--display); font-weight: 600; font-size: 16px; line-height: 1.2; }
        ...
        .qty { display: inline-flex; border: 1px solid var(--line2); border-radius: 8px; margin-top: 10px; overflow: hidden; }
        ...
        .qty .n { width: 34px; display: grid; place-items: center; font-size: 13px; }

        .line .actions { text-align: right; }
        .line .pr { font-family: var(--display); font-weight: 600; font-size: 17px; font-variant-numeric: tabular-nums; text-align: right; }
        .line .rm { font-size: 11px; color: var(--muted); background: none; border: none; display: block; margin-top: 8px; margin-left: auto; transition: color .2s ease; }
        .line .rm:hover { color: var(--ink); text-decoration: underline; }

        .cart-actions { margin-top: 20px; }

        .summary { background: var(--card); border: 1px solid var(--line); border-radius: 16px; padding: 28px; position: sticky; top: 90px; }
        .summary h3 { font-family: var(--display); font-weight: 700; font-size: 21px; margin-bottom: 20px; }

        .promo-region { margin-bottom: 18px; }
        .summary .promo { display: flex; gap: 8px; }
        .summary .promo input { flex: 1; border: 1px solid var(--line2); border-radius: 8px; padding: 11px 14px; font-family: inherit; font-size: 13px; background: var(--bg); color: var(--ink); min-width: 0; }
        .summary .promo input:focus { outline: none; border-color: var(--accent); }
        .summary .promo .btn { padding: 11px 16px; font-size: 13px; }
        .summary .applied { padding: 11px 14px; background: var(--soft); border: 1px solid var(--line); border-radius: 8px; font-size: 13px; display: flex; justify-content: space-between; align-items: center; gap: 8px; }
        .summary .applied .code { font-weight: 700; color: var(--accent); }
        .summary .applied form button { background: none; border: none; font-family: var(--mono); font-size: 11px; letter-spacing: .04em; color: var(--muted); text-decoration: underline; }
        ...
        .summary .r small { font-family: var(--mono); font-size: 11px; }
        ...
        .summary .tot span:last-child { font-family: var(--display); font-variant-numeric: tabular-nums; }
        .summary .secure { margin-top: 16px; text-align: center; font-family: var(--mono); font-size: 11px; color: var(--muted); }
