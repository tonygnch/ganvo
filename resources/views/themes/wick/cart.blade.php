...
@section('content')
    ...
    <style>
        ...
        .cart-empty { background: var(--card); border: 1px solid var(--line); border-radius: 14px; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55); text-align: center; padding: 70px 28px; margin-top: 26px; position: relative; overflow: hidden; }
        .cart-empty::after { content: ""; position: absolute; right: -46px; bottom: -52px; width: 150px; height: 150px; border-radius: 50%; border: 2px solid rgba(217, 154, 78, .20); box-shadow: inset 0 0 22px rgba(217, 154, 78, .14); pointer-events: none; }
        .cart-empty h2 { font-family: var(--display); font-size: 30px; font-weight: 800; letter-spacing: -.02em; margin-bottom: 10px; }
        .cart-empty h2 em { font-family: var(--serif); font-style: italic; color: var(--accent); }
        ...
        .line { display: grid; grid-template-columns: 100px 1fr auto; gap: 20px; background: var(--card); border: 1px solid var(--line); border-radius: 10px; padding: 18px; margin-bottom: 16px; align-items: center; box-shadow: 0 12px 30px -22px rgba(0, 0, 0, .55); transition: border-color .25s ease; }
        .line:hover { border-color: var(--line2); }
        .line .img { height: 100px; width: 100px; border-radius: 6px; overflow: hidden; flex-shrink: 0; }
        .line .img img { width: 100%; height: 100%; object-fit: cover; }
        .line .img .ph, .line .img .bloomph { display: grid; place-items: center; }
        .line .t { font-family: var(--display); font-size: 19px; line-height: 1.2; }
        ...
        .qty { display: inline-flex; border: 1px solid var(--line); border-radius: 99px; margin-top: 10px; overflow: hidden; }
        ...
        .summary { background: var(--card); border: 1px solid var(--line); border-radius: 14px; padding: 30px; position: sticky; top: 100px; box-shadow: 0 16px 38px -24px rgba(0, 0, 0, .55); }
        .summary h3 { font-family: var(--display); font-size: 22px; font-weight: 800; letter-spacing: -.02em; margin-bottom: 20px; }

        .promo-region { margin-bottom: 18px; }
        .summary .promo { display: flex; gap: 8px; }
        .summary .promo input { flex: 1; border: 1px solid var(--line); border-radius: 99px; padding: 11px 16px; font-family: inherit; font-size: 13px; background: var(--bg); color: var(--ink); min-width: 0; }
        .summary .promo input:focus { outline: none; border-color: var(--accent); }
        .summary .promo .btn { padding: 11px 18px; font-size: 13px; }
        .summary .applied { padding: 11px 16px; background: var(--soft); border: 1px solid var(--line); border-radius: 99px; font-size: 13px; display: flex; justify-content: space-between; align-items: center; gap: 8px; }
