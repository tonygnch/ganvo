...
@section('content')
    ...
    <style>
        ...
        /* numbered field sets */
        .fset { background: var(--card); border: 1px solid var(--line); border-radius: 14px; padding: 26px 28px; margin-bottom: 22px; box-shadow: 0 16px 38px -26px rgba(0, 0, 0, .55); }
        .fset h3 { font-family: var(--display); font-size: 19px; font-weight: 800; letter-spacing: -.02em; margin-bottom: 20px; display: flex; align-items: center; gap: 14px; }
        .fset h3 .num { background: var(--accent); color: var(--bg); width: 30px; height: 30px; border-radius: 99px; display: grid; place-items: center; font-family: var(--display); font-size: 15px; flex-shrink: 0; }
        ...
        .stub-notice .icon { display: inline-grid; place-items: center; width: 26px; height: 26px; border-radius: 99px; background: var(--accent); color: var(--bg); font-family: var(--display); flex-shrink: 0; }
        .stub-notice strong { display: block; margin-bottom: 4px; font-family: var(--display); font-weight: 800; letter-spacing: -.02em; }
        .stub-notice em { font-family: var(--serif); font-style: italic; color: var(--accent); }

        /* order summary */
        .osum { background: var(--card); border: 1px solid var(--line); border-radius: 14px; padding: 28px; position: sticky; top: 96px; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55); }
        .osum h2 { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 26px; margin-bottom: 22px; }
        ...
        .osum .oitem .qty-pill { position: absolute; top: -8px; right: -8px; background: var(--accent); color: var(--bg); width: 22px; height: 22px; border-radius: 99px; display: grid; place-items: center; font-family: var(--display); font-size: 11px; box-shadow: 0 2px 6px rgba(0, 0, 0, .5); }
        ...
        .pay-btn { margin-left: auto; display: inline-flex; align-items: baseline; gap: 8px; background: var(--accent); color: var(--bg); border: 1px solid var(--accent); border-radius: 99px; padding: 15px 34px; font-size: 14px; font-weight: 600; transition: filter .25s ease, transform .25s ease, box-shadow .3s ease; }
        .pay-btn:hover { filter: brightness(1.1); transform: translateY(-2px); box-shadow: 0 10px 30px -8px color-mix(in srgb, var(--accent) 55%, transparent); }
