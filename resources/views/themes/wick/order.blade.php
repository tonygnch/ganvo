...
@section('content')
    <style>
        ...
        .ord-hero .mark {
            ...
            border-radius: 99px; background: var(--accent); color: var(--bg);
            font-size: 32px; line-height: 1; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55), 0 0 42px -8px color-mix(in srgb, var(--accent) 55%, transparent);
        }
        .ord-hero .mark.danger { background: var(--jar); }
        .ord-hero h1 { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: clamp(34px, 5vw, 56px); line-height: 1.02; margin-bottom: 14px; }
        ...
        .ord-hero .num {
            ...
            padding: 9px 18px; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55);
        }
        ...
        .ord-ship {
            ...
            box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55);
            padding: 20px 22px; margin-bottom: 26px; display: flex; align-items: center; gap: 18px; flex-wrap: wrap;
        }
        .ord-ship .ic { width: 48px; height: 48px; border-radius: 99px; background: var(--accent); color: var(--bg); display: grid; place-items: center; font-size: 22px; flex-shrink: 0; }
        .ord-ship .tx { flex: 1; min-width: 200px; }
        .ord-ship h3 { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 18px; margin-bottom: 4px; color: var(--ink); }
        ...
        .ord-card { background: var(--card); border: 1px solid var(--line); border-radius: 14px; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55); padding: 24px 26px; }
        .ord-card > h3 {
            font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 20px; color: var(--ink);
        ...
        /* ===== items + totals ===== */
        .ord-items { background: var(--card); border: 1px solid var(--line); border-radius: 14px; box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55); overflow: hidden; }
        .ord-items > h3 { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 20px; color: var(--ink); padding: 20px 26px; border-bottom: 1px solid var(--line); }
        ...
        .ord-item .name { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 18px; line-height: 1.2; color: var(--ink); }
        ...
        .ord-tot .grand .label { font-family: var(--display); font-weight: 800; letter-spacing: -.02em; font-size: 18px; color: var(--ink); }
