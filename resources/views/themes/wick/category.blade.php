...
@section('content')
    <style>
        ...
        .pills span.on { color: var(--bg); background: var(--accent); border-color: var(--accent); }

        /* filter rail */
        .filters {
            background: var(--card); border: 1px solid var(--line); border-radius: 14px;
            box-shadow: 0 16px 38px -22px rgba(0, 0, 0, .55); overflow: hidden; position: relative;
        }
        ...
        .filters .field label {
            font-family: var(--body); font-size: 11px; font-weight: 600; letter-spacing: .08em;
        ...
        .filters select {
            ...
            border-radius: 10px; font-family: var(--body); font-size: 14px; color: var(--ink); width: 100%;
        ...
        /* result count line — serif italic, apothecary motif bullet */
        .toolbar {
        ...
        .toolbar::before { content: "◆"; color: var(--accent); font-style: normal; }
    ...
    <main>
        <div class="wrap">
            ...
            {{-- Decorative seasonal pills — purely visual; real filtering lives in the rail. --}}
            <div class="pills" aria-hidden="true">
                <span class="on">{{ $category->name }}</span>
                <span>{{ __('site.storefront.wick.pill_low') }}</span>
                <span>{{ __('site.storefront.wick.pill_poured') }}</span>
                <span>{{ __('site.storefront.wick.pill_hand') }}</span>
            </div>
