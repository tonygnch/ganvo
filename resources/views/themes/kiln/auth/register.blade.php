...
@section('content')
    <style>
        ...
        /* errors */
        .auth .errors { text-align: left; border: 1px solid #9c5a3e; background: color-mix(in srgb, #9c5a3e 8%, var(--card)); color: var(--ink); border-radius: 2px; padding: 12px 16px; margin-bottom: 22px; font-size: 13px; }
    ...
    <main>
        <section class="auth">
            <div class="card reveal">
                ...
                @php
                    // Kiln editorial accent: italicise the final word of the (escaped) title.
