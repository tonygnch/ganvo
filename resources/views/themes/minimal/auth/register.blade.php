...
@section('content')
    <style>
        ...
        .auth-head h1 { font-family: var(--display); font-size: clamp(30px,5vw,42px); margin-top: 12px; }
        ...
        .field-label { display: block; font-size: 11px; letter-spacing: .08em; text-transform: uppercase; color: var(--muted); margin-bottom: 8px; } .field-label small { text-transform: none; letter-spacing: 0; }
        ...
        .marketing-field { margin-top: 14px; } .marketing-label { display: flex; align-items: flex-start; gap: 9px; font-size: 13px; color: #7a5e54; cursor: pointer; } .marketing-label input { accent-color: var(--accent); margin-top: 3px; }
        .auth-submit { width: 100%; background: var(--accent); color: #fff; border: 0; border-radius: 99px; padding: 15px; font-weight: 600; font-size: 14px; cursor: pointer; margin-top: 10px; }
