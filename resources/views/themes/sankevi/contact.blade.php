...
@section('content')
    <style>
        ...
        .field input, .field select, .field textarea { width: 100%; background-color: var(--bg); border: 1px solid var(--line2); padding: 13px 15px; font-family: var(--body); font-size: 14.5px; color: var(--txt); transition: border-color .25s ease; }
