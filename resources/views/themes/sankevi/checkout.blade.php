{{--
 | Sankevi — checkout. The dispatch desk: three ruled sheets (details →
 | delivery → payment) with the load docket standing beside them. Same wizard
 | mechanics as every other theme; only the paper changed.
--}}
@php
...
@section('content')
    ...
    <style>
        ...
        .field input, .field select, .field textarea { background: var(--bg); border: 1px solid var(--line2); padding: 13px 15px; font-family: var(--body); font-size: 14.5px; color: var(--txt); transition: border-color .25s ease; }
        ...
        .osum .oitem .m { margin-top: 3px; font-size: 10px; font-weight: 500; letter-spacing: .16em; text-transform: uppercase; color: var(--muted); }
        ...
        .osum .tot span:last-child { font-size: 25px; font-variant-numeric: tabular-nums; color: var(--accent); }
