...
@section('content')
    <style>
        ...
        .ord-hero .num { display: inline-block; margin-top: 24px; padding: 10px 18px; border: 1px solid var(--line2); font-size: 11px; font-weight: 500; letter-spacing: .24em; text-transform: uppercase; color: var(--accent); }
        ...
        @media (max-width: 720px) {
            ...
            .ord-card { padding: 20px 20px 18px; }
        ...
        <div class="wrap">
            <div class="ord">
                ...
                <div class="ord-hero reveal">
                    <div class="mark cut cut-sm {{ $markClass }} {{ $isPending ? 'wait' : '' }}"><span>{{ $iconChar }}</span></div>
                    <h1>
                        @if ($isCancelled)
