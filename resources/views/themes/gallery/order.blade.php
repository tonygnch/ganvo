...
@section('content')
    <style>
        ...
        .ord-icon { width: 64px; height: 64px; border-radius: 14px; margin: 0 auto 22px; display: grid; place-items: center; font-size: 26px; background: var(--accent); color: #faf7f1; }
        .ord-icon.bad { background: #c2705a; }
        .ord-hero h1 { font-family: var(--display); font-weight: 700; font-size: clamp(32px,4.5vw,46px); letter-spacing: -.02em; }
        .ord-hero p { color: var(--muted); margin-top: 10px; max-width: 46ch; margin-left: auto; margin-right: auto; }
        .ord-num { display: inline-block; margin-top: 18px; padding: 8px 18px; border: 1px solid var(--line); border-radius: 8px; font-size: 13px; letter-spacing: .06em; }
        .ord-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px; }
        .ord-card { background: var(--card); border: 1px solid var(--line); border-radius: 16px; padding: 24px; }
        .ord-card h3 { font-size: 11px; letter-spacing: .08em; text-transform: uppercase; color: var(--muted); margin-bottom: 16px; }
        ...
        .ord-items { background: var(--card); border: 1px solid var(--line); border-radius: 16px; padding: 24px; }
        .ord-items > h3 { font-size: 11px; letter-spacing: .08em; text-transform: uppercase; color: var(--muted); margin-bottom: 8px; }
        ...
        .ord-line .nm { font-family: var(--display); font-weight: 600; font-size: 16px; } .ord-line .meta { font-size: 12px; color: var(--muted); margin-top: 3px; }
        .ord-line .pr { font-family: var(--display); font-weight: 600; white-space: nowrap; }
        ...
        .ord-tot .grand { display: flex; justify-content: space-between; border-top: 1px solid var(--line); margin-top: 10px; padding-top: 14px; font-size: 18px; font-weight: 700; } .ord-tot .grand .num { font-family: var(--display); color: var(--accent); }
